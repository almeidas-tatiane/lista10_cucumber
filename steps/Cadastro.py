...
def preencho_os_campos_name_company_e_mail_address_password_confirm_password(context,name_company,e_mail_address,password,confirm_password):
    print(f'Passo 4- Preenchendo campos do cadastro: {name_company}, {e_mail_address}, {password}, {confirm_password}')
